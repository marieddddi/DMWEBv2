...
$(document).ready(function () {
  ...
  $(document).on("click", ".croix", function () {
    ...
    // Utilisation de la fonction supprimer_smiley
    // Faites un appel AJAX pour supprimer la table-container correspondant à cet utilisateur
  });
  ...
  $(document).on("click", "#DupliquerSmiley", function () {
    if (!tableauClique) {
      ...
      tableauClique = true; // Mettez la variable à true pour indiquer que le tableau a été cliqué
    }
  });
